...
export default function InAppNotice() {
  ...
  return (
    ...
    >
      ...
      <DialogPanel
        className="w-full max-w-lg rounded-2xl border border-[var(--color-border)] bg-[linear-gradient(180deg,rgba(31,22,56,0.96),rgba(18,12,35,0.98))] p-5 shadow-e3 sm:p-7"
      >
