...
const tabs: Tab[] = [
  ...
  },
  {
    ...
    group: "support",
    icon: "M2.5 18.5h19a1 1 0 011 1v1a1 1 0 01-1 1h-19a1 1 0 01-1-1v-1a1 1 0 011-1zM4 7a1 1 0 011-1h2a1 1 0 011 1v11.5H4V7zm5-2a1 1 0 011-1h2a1 1 0 011 1v13.5H9V5zm4.55 1.1a1 1 0 01.7-1.23l1.93-.52a1 1 0 011.23.7l3.48 12.98-3.87 1.04L13.55 6.1zm3.65 2.5a1 1 0 01.77-1.19l1.7-.35a1 1 0 011.18.78l1.75 8.6-3.7.76-1.7-8.6z",
  },
  {
