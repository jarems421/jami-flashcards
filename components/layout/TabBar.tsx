...
const tabs: Tab[] = [
  ...
  },
  {
    ...
    group: "support",
    icon: "M4.15 16.35a1.4 1.4 0 011.73-.97l12.84 3.44a1.4 1.4 0 01-.72 2.7L5.16 18.08a1.4 1.4 0 01-1.01-1.73zM3.2 11.05a1.4 1.4 0 011.62-1.14l13.2 2.33a1.4 1.4 0 01-.49 2.76l-13.2-2.33a1.4 1.4 0 01-1.13-1.62zM5.08 4.24a1.4 1.4 0 011.71-.99l12.9 3.34a1.4 1.4 0 01-.7 2.71L6.08 5.95a1.4 1.4 0 01-1-1.71z",
  },
  {
