...
const tabs: Tab[] = [
  ...
  },
  {
    ...
    group: "support",
    icon: "M2.5 17.65h19a1 1 0 011 1v1.85a1 1 0 01-1 1h-19a1 1 0 01-1-1v-1.85a1 1 0 011-1zM4.25 4.25a1.25 1.25 0 011.25-1.25h2.45A1.25 1.25 0 019.2 4.25v13.4H4.25V4.25zM8.75 4.85a1.15 1.15 0 01.94-1.32l2.25-.36a1.15 1.15 0 011.32.94l2.2 13.54h-4.45L8.75 4.85zM12.45 5.55a1.15 1.15 0 01.82-1.4l2.18-.57a1.15 1.15 0 011.4.82l3.45 13.25h-4.48L12.45 5.55zM15.55 6.8a1.15 1.15 0 01.69-1.47l2.08-.76a1.15 1.15 0 011.47.69l4.05 12.39h-4.5L15.55 6.8z",
  },
  {
    ...
    group: "support",
    icon: "M6.5 3.25h7.75l4.5 4.5v7.75a3.25 3.25 0 01-3.25 3.25h-9A3.25 3.25 0 013.25 15.5v-9A3.25 3.25 0 016.5 3.25zm1.25 5.25a1.25 1.25 0 100-2.5 1.25 1.25 0 000 2.5zM7 12.25h8.5M7 15.5h5.5",
  },
  {
