...
export default function AppTopBar({
  ...
  return (
    ...
    >
      <div className="app-topbar rounded-[1.6rem] border-[1.5px] border-white/[0.18] bg-[linear-gradient(180deg,rgba(31,22,56,0.88),rgba(19,12,38,0.88))] px-2.5 py-2.5 shadow-[0_18px_40px_rgba(7,2,22,0.26)] backdrop-blur-xl sm:rounded-[2.4rem] sm:px-4 sm:py-3">
