...
export default function DeckCoverIcon({
  ...
  return (
    <div
      className={`${className} flex shrink-0 items-center justify-center rounded-[1.2rem] border border-white/[0.14] bg-gradient-to-br ${color.className} text-white shadow-[0_16px_32px_rgba(7,2,22,0.24)]`}
      title={icon.label}
    >
