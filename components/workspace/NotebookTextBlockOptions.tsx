  ...
  return (
    ...
    >
      <button
        ...
        className="inline-grid h-7 w-7 place-items-center rounded-sm border border-black/15 bg-black/60 text-[#f8fafc] shadow-sm backdrop-blur-sm transition hover:bg-black/75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f8fafc] [&_svg]:h-4 [&_svg]:w-4"
      ...
      {open ? (
        <div
          ...
          tabIndex={-1}
          aria-label="Text box options"
          className={`absolute z-40 min-w-44 overflow-hidden rounded-md border border-[var(--color-border)] bg-[var(--color-surface-panel-strong)] p-1.5 shadow-[0_18px_46px_rgba(0,0,0,0.28)] ${
        ...
        >
          <button
            ...
            className="flex w-full items-center justify-between gap-4 rounded-sm px-3 py-2 text-left text-sm font-medium text-text-primary transition hover:bg-[var(--color-glass-subtle)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
            onPointerDown={(event) => event.stopPropagation()}
            onClick={(event) => {
              event.stopPropagation();
              onToggleOutline();
          ...
          <button
            ...
            className="mt-0.5 flex w-full items-center gap-2.5 rounded-sm px-3 py-2 text-left text-sm font-semibold text-error transition hover:bg-[var(--color-error-muted)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-error [&_svg]:h-4 [&_svg]:w-4"
            onPointerDown={(event) => event.stopPropagation()}
            onClick={(event) => {
              event.stopPropagation();
              onDelete();
