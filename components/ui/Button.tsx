...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "border border-white/18 bg-[linear-gradient(180deg,#92e5d7_0%,#7fc9d9_52%,#8f7de8_100%)] text-[#071018] shadow-[0_14px_26px_rgba(92,190,178,0.18)] hover:-translate-y-[1px] hover:brightness-105 hover:shadow-[0_18px_32px_rgba(92,190,178,0.24)] active:translate-y-0 active:scale-[0.98] disabled:opacity-50",
  secondary:
  ...
  surface:
    "border border-white/14 bg-[linear-gradient(180deg,rgba(24,30,45,0.94),rgba(15,19,31,0.94))] text-white shadow-[var(--shadow-shell)] hover:-translate-y-[1px] hover:border-white/18 hover:bg-[linear-gradient(180deg,rgba(30,37,55,0.96),rgba(18,23,36,0.96))] hover:shadow-[0_20px_38px_rgba(4,8,18,0.34)] active:translate-y-0 active:scale-[0.98] disabled:opacity-50",
  danger:
  ...
  warm:
    "border border-white/20 bg-[linear-gradient(180deg,#f7fffd_0%,#d7fbf3_46%,#b9f0e5_100%)] text-[#071018] shadow-[0_12px_24px_rgba(92,190,178,0.18)] hover:-translate-y-[1px] hover:brightness-105 hover:shadow-[0_16px_30px_rgba(92,190,178,0.24)] active:translate-y-0 active:scale-[0.98] disabled:opacity-50",
};
