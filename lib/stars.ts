...
export const STAR_MIN_VISUAL_SIZE = 10;
const STAR_MAX_VISUAL_SIZE = 86;
const STAR_SIZE_CURVE_EXPONENT = 2.35;
...
export function getStarColor(completedGoalsCount: number): string {
...
export const STAR_PRESET_ICON_MAP: Record<StarPresetId, string> = {
  classic: "noun-star-1092436.svg",
  "blue-spark": "noun-star-3819038.svg",
  "gold-burst": "noun-star-949371.svg",
  "violet-comet": "noun-stars-1354331.svg",
  "magenta-elite": "noun-stars-4786569.svg",
};
...
export function resolveStarPresetId(goal: Goal): StarPresetId {
  void goal;
  return "classic"; // Default to northern star look for all stars
}
...
export function getLegacyStarVisualSize(starSize: number) {
...
export function getEffectiveStarVisualSize(star: {
  ...
  return star.isLegacyStar ? getLegacyStarVisualSize(star.size) : getStarVisualSize(star.size);
}
