...
export const SCHEME_RULES = [
  ...
  "A question asking for a number of things -- \"list four things\", \"give two reasons\" -- is a pool: give each answer the scheme accepts as its own point worth one mark, and set awardable to the number the question asks for. Never collapse them into one point with the rest as its alternatives, which reads as a one-mark answer to a four-mark question.",
